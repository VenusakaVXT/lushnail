...
class TabManager {
    ...
    initTabContainer(container, index) {
        ...
        // Enable drag-to-scroll cho tab-menu-wrapper
        const tabMenuWrapper = container.querySelector('.tab-menu-wrapper');
        if (tabMenuWrapper) {
            this.enableDragScroll(tabMenuWrapper);
        }
    ...
    /**
     * Enable drag-to-scroll cho tab menu wrapper
     * @param {HTMLElement} element - Tab menu wrapper element
     */
